  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        leather: "bg-gradient-leather text-primary-foreground hover:shadow-leather hover:-translate-y-0.5 shadow-elegant",
        gold: "bg-gradient-gold text-accent-foreground hover:shadow-gold hover:-translate-y-0.5 shadow-elegant font-semibold",
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-leather hover:-translate-y-0.5 shadow-gold font-semibold",
      },
      size: {
